...
impl HD44780LCD {
    ...
    pub fn clear(&self) {
        unsafe {
            hd44780_clear(self.dev as *const hd44780_t);
        }
    }

    pub fn home(&self) {
        unsafe {
            hd44780_home(self.dev as *const hd44780_t)
        }
    }
    pub fn set_cursor(&self, col: u8, row: u8) {
        unsafe {
            hd44780_set_cursor(self.dev as *const hd44780_t, col, row);
        }
    }
    pub fn display(&mut self, state: hd44780_state_t) {
        unsafe {
            hd44780_display(self.dev as *mut hd44780_t, state)
        }
    }
    pub fn cursor(&mut self, state: hd44780_state_t) {
        unsafe {
            hd44780_cursor(self.dev as *mut hd44780_t, state)
        }
    }
    pub fn blink(&mut self, state: hd44780_state_t) {
        unsafe {
            hd44780_blink(self.dev as *mut hd44780_t, state)
        }
    }
    pub fn scroll_left(&self) {
        unsafe {
            hd44780_scroll_left(self.dev as *const hd44780_t)
        }
    }
    pub fn scroll_right(&self) {
        unsafe {
            hd44780_scroll_right(self.dev as *const hd44780_t)
        }
    }
    pub fn left2right(&mut self) {
        unsafe {
            hd44780_left2right(self.dev as *mut hd44780_t)
        }
    }
    pub fn right2left(&mut self) {
        unsafe {
            hd44780_right2left(self.dev as *mut hd44780_t)
        }
    }
    pub fn autoscroll(&mut self, state: hd44780_state_t) {
        unsafe {
            hd44780_autoscroll(self.dev as *mut hd44780_t, state)
        }
    }
    pub fn create_char(&self, location: u8, charmap: &[u8]) {
        unsafe {
            hd44780_create_char(self.dev as *mut hd44780_t, location, charmap as *const [u8])
        }
    }
    pub fn write(&self, value: u8) {
        unsafe {
            hd44780_write(self.dev as *const hd44780_t, value)
        }
    }
    ...
    pub fn print(&self, data: &str) {
        ...
        unsafe {
            hd44780_print(self.dev as *const hd44780_t, c_str.as_ptr() as *const u8);
        }
    }
}

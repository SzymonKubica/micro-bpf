...
static void __attribute__((noinline)) led_set_state(bpf_saul_reg_t *led, uint32_t state);
static void __attribute__((noinline)) led_turn_off(bpf_saul_reg_t *led);
static void __attribute__((noinline)) led_turn_on(bpf_saul_reg_t *led);
...
static void __attribute__((noinline)) led_turn_off(bpf_saul_reg_t *led) { led_set_state(led, 0); }

static void __attribute__((noinline)) led_turn_on(bpf_saul_reg_t *led) { led_set_state(led, 1); }
